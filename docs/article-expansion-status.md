...
The clean GitHub recovery began with four deployed curated articles. This work expands the local, reviewable dataset to seven source-supported articles. No Atlas deployment or ingestion has been performed from this branch.
...
| AO slow/stuck Moodle copy | `MOODLE-COPY-003` | Included | Verified Atlas article | None |
| TM verify enrollment status | `MCELE-ENROLLMENT-REPORT-001` | Included | Verified Atlas report article plus approved scenario | Report fields remain deliberately unspecified |
| Student repeat course for RRC | `MCELE-RRC-001` | Included | Confirmed Help Desk answer plus verified catalog guidance | None |
