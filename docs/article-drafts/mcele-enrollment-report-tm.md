# Verify a Marine's enrollment status with the Enrollment Report
...
- Content type: Adapted existing guidance and user-approved scenario, not synthetic
- Provenance: Atlas `/home/velvux/ChatBotLLM/knowledge/rag-source-documents/converted/confluence/i-m-the-mcele-training-manager-tm-for-my-unit-how-do-i-run-a-mcele-report.md`, selectively read on 2026-09-16; SHA-256 `2cec84398147d8bd7552bd96518fcdbe645d5f32cb6c2ff1aaca3ea658b3f074`
- Scenario provenance: Real ticket 118579 establishes the Enrollment Report use case; the ticket number remains internal and is not embedded in the knowledge content
- Redistribution status: To be confirmed before public submission packaging; no license inferred

## Knowledge content

As a **Training Manager**, use the **Enrollment Report** in MCeLE to verify a Marine's enrollment status.

1. Log in to **MCeLE** and confirm that your active role is **Training Manager**.
